...
module.exports = {
    'beertag.foo.fetch': ({filterBy: {tenant}}) => fooList.filter(foo => tenant == null || String(foo.tenant) === String(tenant)),
    'beertag.foo.get': findFoo,
    'beertag.foo.add': foo => {
        lastFooId += 1;
