...
import { setConfig as setCustomerConfig } from 'ut-customer/ui/react/configuration/actions.js';
...
class ConfigProvider extends Component {
    componentDidMount() {
        ...
        this.props.setCustomerConfig(customerConfig);
...
ConfigProvider.propTypes = {
    ...
    setCustomerConfig: PropTypes.func,
...
export default connect(
    null,
    { setUserConfig, setCustomerConfig, setHistoryConfig, setAuditConfig }
)(ConfigProvider);
